...
# https://www.youtube.com/watch?v=nj-alxd7YvM
...
def crear():
    ...
    DATOS = MiNombre.get(), MiPassword.get(), MiApellido.get(), MiDireccion.get(), cuadroComentario.get("1.0", END)
